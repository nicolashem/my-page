 ...
 svg.makeLine({ parent: dom.svgLayer, id: "rope", join: "bevel", cap: "round", stroke: 0.3, color: "#217AE7" });
 svg.makeLine({ parent: dom.svgLayer, id: "rope2", join: "bevel", cap: "round", stroke: 0.3, color: "#217AE7" });

 svg.makeLine({ parent: dom.svgLayer, id: "circles", stroke: 4, color: "#ff0", cap: "round" });

 svg.makeLine({ parent: dom.svgLayer, id: "ropeworm", join: "bevel", cap: "round", stroke: 0.1, color: "#217AE7" });
 svg.makeLine({ parent: dom.svgLayer, id: "circlesworm", stroke: 0.5, color: "#f00", cap: "round" });
 

 let test = [];
 for (let i = 0; i < 70; i++) {
     test.push(physics.makePoint({ id: "blob" + i, drag: 1, position: { x: 5, y: 5 } }));
 }
